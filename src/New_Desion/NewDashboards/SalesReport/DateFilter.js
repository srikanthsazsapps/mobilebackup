...
const DateFilter = ({ dashboardType = "Sales", onFilterChange }) => {
  ...
  const handleSelect = async (value) => {
    ...
    try {
      const dashType = dashboardType.toLowerCase();
      switch (value) {
        case "Today":
          await SetToday(dashType);
          setSelectedPeriodType('day');
          onFilterChange?.("Today");
          break;
        case "Yesterday":
          await SetYesterday(dashType);
          setSelectedPeriodType('day');
          onFilterChange?.("Yesterday");
          break;
        case "Week":
          await SetWeek(dashType);
          setSelectedPeriodType('week');
          onFilterChange?.("Week");
          break;
        case "Month":
          await SetMonth(dashType);
  ...
  const handleCustomSelect = async () => {
    ...
    try {
      await fetchDataCustom(startDateTime, endDateTime, dashboardType.toLowerCase());
